...
game_over = pg.image.load(r"C:\Users\sanch\Downloads\gameover.jpg")
bg = pg.image.load(r"C:\Users\sanch\Downloads\AnimatedStreet (1).png")
...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\sanch\Downloads\Enemy (1).png") # загружаем картинку
...
class Player(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\sanch\Downloads\Player.png") # загружаем картинку
        self.rect = self.image.get_rect()
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\sanch\Downloads\coin (1).png") # загружаем картинку
        self.rect = self.image.get_rect()
...
while is_running:
    ...
    while lose:
        ...
        for event in pg.event.get():
            if event.type == pg.QUIT:
                is_running = False
                lose = False  # Выходим из цикла "game over" и основного цикла
